-- First, fix any existing invalid lobby_type values
UPDATE public.lobbies 
SET lobby_type = CASE 
  WHEN lobby_type LIKE '%2%' THEN 'quiz-2'
  WHEN lobby_type LIKE '%4%' THEN 'quiz-4'
  ELSE 'quiz-2'
END;
...
-- Add user_code column and invitation system
